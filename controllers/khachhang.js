...
router.get('/:id(\\d+)',function(req,res){
    let query = "SELECT * FROM tgr_khac_hang WHERE id = ? ";
...
router.post('/', function(req, res){
    if( req.body.ma && req.body.ten && req.body.sdt && req.body.dia_chi ){
        let query = "INSERT INTO tgr_khach_hang ( ten, gioi_tinh, ngay_sinh, dia_chi, sdt, email, password ) VALUES(?,?,?)";
